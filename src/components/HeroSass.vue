                    ...
                    <div class="swiper-slide" :style="bgImg">
                        <div class="hero-item text-center">
                            <div class="hero-content">
                                <h2 class="h1 hero-content-title font-weight-light">Suas finanças empresariais estão em dia?</h2>
                                <h6 class="hero-content-subtitle"><b>Não?</b> Nós temos a solução para seu problema, um sistema de gestão pensado em pequenas empresas.</h6>
                            ...
                            <div class="hero-thumb">
                                <img src="" class="img-fluid" alt="hero thumb">
                            </div>
                        </div>
                    </div>
                    <!-- <div class="swiper-slide" :style="bgImg">
...
export default {
    data() {
        return {
            bgImg: {
               backgroundImage: `url(${require("../assets/img/hero/hero-sass/finance.png")})`
            },
            swiperOption: {
                speed: 1500,
                loop: true,
